...
const Banner = () => {
    ...
    return (
        <div>
            ...
            <div className='row my-5 ChairpersonSMSContainer'>
                <div className='col-md-3 BScInCSE' style={{  textAlign:'center' }}>
                    <p>Quick Links</p>
                    <a href="">BSc in CSE</a>
                </div>
                <div className='col-sm-12 col-md-9 MessageChar' id='Chairperson'>
                    <p>Message from the Chairperson</p>
                    <div className='row'>
                        <div className="col-sm-12 col-md-2 massageImg" style={{  padding:"0px"}}>
                            <img src={ChairpersonCSEMilonSir} alt="" />
                        </div>
                        <div className="col-sm-12 col col-md-10 massageText" >
                            <span>
